...
const Widget = () => {
	return (
		<div className="w-[448px] overflow-hidden rounded">
			...
			<div>
				<div className="bg-zinc-950 text-sm px-5 py-2 text-zinc-400">
					Recentes
				</div>

				<div className="divide-y-2 divide-zinc-950">
					<div className="bg-zinc-900 py-4 px-8 flex items-start gap-6">
			...
			<div>
				...
				<div className="divide-y-2 divide-zinc-950">
					...
					<div className="bg-zinc-900 py-4 px-8 flex items-start gap-6">
						<Rocket className="w-6 h-6 text-violet-500 mt-3" />
						<div className="flex-1 flex flex-col gap-2 text-zinc-400">
							<p className="text-sm leading-relaxed text-zinc-400">
								Você recebeu um convite para fazer parte da empresa Rocketseat.
							</p>
							<div className="text-xxs text-zinc-400 flex gap-1 items-center">
